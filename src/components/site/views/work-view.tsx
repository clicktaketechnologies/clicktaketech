    ...
    <>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          ...
          <Reveal delay={0.05}>
            <h1 className="mt-6 max-w-4xl text-4xl font-bold leading-[1.05] tracking-tight sm:text-5xl lg:text-6xl">
              Real clients. <span className="text-gradient-emerald">Real numbers.</span>
            </h1>
          </Reveal>
          <Reveal delay={0.1}>
          ...
          {CASE_STUDIES.map((cs, i) => (
            <Reveal key={cs.title} delay={i * 0.04}>
              <article className="group relative overflow-hidden rounded-3xl border border-border/50 bg-card/40 p-6 sm:p-8 lg:p-10">
                <div className="absolute -right-20 -top-20 h-56 w-56 rounded-full bg-emerald-500/5 blur-3xl transition-all duration-500 group-hover:bg-emerald-500/12" />
      ...
      <Section className="border-t border-border/40">
        <SectionHeading
          ...
          title={
            <>
              Production work, <span className="text-gradient-emerald">live right now.</span>
            </>
          }
        ...
        <Reveal delay={0.05}>
          <div className="mt-8 flex flex-wrap gap-3">
            {[
              ...
              >
                <span className="text-2xl font-bold text-gradient-emerald">{c.count}</span>
                <div>
